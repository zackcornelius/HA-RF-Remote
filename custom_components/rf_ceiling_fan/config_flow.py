"""Config flow for the RF Ceiling Fan integration."""
...
from .const import CONF_TRANSMITTER, DOMAIN, FREQUENCY, MODULATION


class RFCeilingFanConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for RF Ceiling Fan."""
